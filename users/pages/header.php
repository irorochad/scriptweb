	...
	<div class="wrapper static-sidebar">
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="purple">
				...
				<a href="index.php?username=<?php  echo $_SESSION['username']?>&email=<?php  echo $_SESSION['email']?>" class="logo">
				
					<img src="https://<?php echo $bankurl;?>/admin/c2wad/logo/<?php echo $logo;?>" alt="navbar brand" class="navbar-brand" style="height:30px;width:30px; margin-top:15px; border-radius:50%">
